...
const projects = [
  ...
  //   description: "Full-stack bug tracking system with role-based access control using Spring Boot, React, and PostgreSQL.",
  //   // demo: "#",
  //   code: "https://github.com/geno3337/bug-tracker",
  ...
  // },
  {
    ...
    description: "A web app for translating between multiple languages using external APIs, built with React and Spring Boot.",
    // demo: "#",
